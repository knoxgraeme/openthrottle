...
export const REVIEW_FINDING_SEVERITIES = ["P0", "P1", "P2", "P3"];
...
const REVIEW_FINDING_FIELDS = ["anchor", "evidence", "path", "severity", "title"];
...
function parseReviewFinding(value, path) {
